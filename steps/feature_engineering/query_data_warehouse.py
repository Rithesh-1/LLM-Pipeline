...
from llm_pipeline_system.domain.base.nosql import NoSQLBaseDocument
from llm_pipeline_system.domain.documents import ArticleDocument, Document, PostDocument, RepositoryDocument, UserDocument
...
def query_data_warehouse(
    ...
    try:
        ...
        mlflow.log_dict(metadata, "raw_documents_metadata.json")
        mlflow.log_metric("total_documents_queried", len(documents))
        mlflow.log_metric("total_authors_queried", len(authors))
